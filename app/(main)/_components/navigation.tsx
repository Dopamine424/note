...
import { fixOrder } from "@/firebase/utils";
...
export const Navigation = ({ isGraphOpen, setIsGraphOpen }: NavigationProps) => {
  ...
  useEffect(() => {
    fixOrder().catch((error) => console.error("fixOrder error:", error));
  }, []);
      ...
      <>
        ...
        >
          ...
          <div className="mt-4">
            ...
            <Item onClick={handleCreate} icon={Plus} label="Добавить записку" />
            <div className="mt-4">
              <h3 className="px-3 text-sm font-medium text-muted-foreground">
                Теги
              </h3>
